...
hallway_Module_Door_02.addComponentOrReplace(transform_27)
...
fence_Straight_01.addComponentOrReplace(transform_28)
...
fence_Straight_01_2.addComponentOrReplace(transform_29)
...
fence_Straight_01_3.addComponentOrReplace(transform_30)
...
fence_Straight_01_4.addComponentOrReplace(transform_31)
...
fence_Straight_01_5.addComponentOrReplace(transform_32)
...
fence_Straight_01_6.addComponentOrReplace(transform_33)
...
fence_Straight_01_7.addComponentOrReplace(transform_34)
...
fence_Straight_01_8.addComponentOrReplace(transform_35)
...
fence_Straight_01_9.addComponentOrReplace(transform_36)
...
fence_Straight_01_10.addComponentOrReplace(transform_37)
...
floor_Module_01.addComponentOrReplace(transform_38)
...
floor_Module_01_2.addComponentOrReplace(transform_39)
...
floor_Module_01_3.addComponentOrReplace(transform_40)
...
stone_05.addComponentOrReplace(transform_41)
...
stone_04.addComponentOrReplace(transform_42)
...
stone_04_2.addComponentOrReplace(transform_43)
...
dirt_02.addComponentOrReplace(transform_44)
...
crater_02.addComponentOrReplace(transform_45)
...
dirt_03.addComponentOrReplace(transform_46)
...
crater_01.addComponentOrReplace(transform_47)
...
lampPostSciFi_01.addComponentOrReplace(transform_48)
...
lampPostSciFi_01_2.addComponentOrReplace(transform_49)
...
oxygenStorage_01.addComponentOrReplace(transform_50)
...
crateBlueBig_01.addComponentOrReplace(transform_51)
...
battery_02.addComponentOrReplace(transform_52)
...
battery_02_2.addComponentOrReplace(transform_53)
...
drawer_02.addComponentOrReplace(transform_54)
...
crateYellowBig_01.addComponentOrReplace(transform_55)
...
crateYellowBig_01_2.addComponentOrReplace(transform_56)
...
neonLightTube_01.addComponentOrReplace(transform_57)
...
neonLightTube_01_2.addComponentOrReplace(transform_58)
...
neonLightTube_04.addComponentOrReplace(transform_59)
...
neonLightTube_04_2.addComponentOrReplace(transform_60)
...
crateOrange_01.addComponentOrReplace(transform_61)
...
fence_Straight_02.addComponentOrReplace(transform_62)
...
fence_End_01.addComponentOrReplace(transform_63)
...
fence_End_01_2.addComponentOrReplace(transform_64)
...
fence_End_01_3.addComponentOrReplace(transform_65)
...
fence_End_01_4.addComponentOrReplace(transform_66)
engine.addEntity(fence_End_01_4)

const streetFence_01_4 = new Entity()
streetFence_01_4.setParent(scene)
streetFence_01_4.addComponentOrReplace(gltfShape_2)
const transform_67 = new Transform({
  position: new Vector3(31.729932295233766, 0, 35.29723408846401),
  rotation: new Quaternion(0, -0.7071067811865479, 0, 0.7071067811865477),
  scale: new Vector3(11.5, 1, 1)
})
streetFence_01_4.addComponentOrReplace(transform_67)
engine.addEntity(streetFence_01_4)

const streetFence_01_5 = new Entity()
streetFence_01_5.setParent(scene)
streetFence_01_5.addComponentOrReplace(gltfShape_2)
const transform_68 = new Transform({
  position: new Vector3(0.1577778523582225, 0, 35.159149020614954),
  rotation: new Quaternion(0, -0.7071067811865479, 0, 0.7071067811865477),
  scale: new Vector3(11.5, 1, 1)
})
streetFence_01_5.addComponentOrReplace(transform_68)
engine.addEntity(streetFence_01_5)

const streetFence_01_6 = new Entity()
streetFence_01_6.setParent(scene)
streetFence_01_6.addComponentOrReplace(gltfShape_2)
const transform_69 = new Transform({
  position: new Vector3(16, 0, 47.75774654936962),
  rotation: new Quaternion(0, 1, 0, 1.942890293094024e-16),
  scale: new Vector3(14, 1, 1)
})
streetFence_01_6.addComponentOrReplace(transform_69)
engine.addEntity(streetFence_01_6)

const crater_01_2 = new Entity()
crater_01_2.setParent(scene)
crater_01_2.addComponentOrReplace(gltfShape_18)
const transform_70 = new Transform({
  position: new Vector3(14, 0, 15),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(2, 1, 1.5)
})
crater_01_2.addComponentOrReplace(transform_70)
